...
#     SHORT_TERM_VOLUME_THRESHOLD = 350000  # Example threshold value
...
#                 if market_cap > 15_000_000 or market_cap < 700_000:
    ...
    while True:
        try:
            ...
            for top_token in top_tokens:
                ...
                if market_cap > 20_000_000 or market_cap < 500_000:
                    bot.logger.info(f"Skipping {token_address} (MC: ${market_cap:,.2f})")
                    continue
